...
@section('title', 'LIST OF PENDING REQUEST LEAVES')
        ...
        <div class="card mt-2">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h5 class="card-title">LIST OF PENDING REQUEST LEAVES</h5>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <form action="/leave/request/update/to/approved/with/pay/{{ $requestLeave->request_leave_id }}" method="post">
                                                @method('PUT')
                                                @csrf
                                                <button type="submit" class="btn btn-primary">SET TO APPROVE WITH PAY</button>
                                            </form>
                                            <form action="/leave/request/update/to/approved/without/pay/{{ $requestLeave->request_leave_id }}" method="post">
                                                @method('PUT')
                                                @csrf
                                                <button type="submit" class="btn btn-primary">SET TO APPROVE WITHOUT PAY</button>
                                            </form>
