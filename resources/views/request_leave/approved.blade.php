...
@section('title', 'LIST OF APPROVED REQUEST LEAVES')
        ...
        <div class="card mt-2">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h5 class="card-title">LIST OF APPROVED REQUEST LEAVES</h5>
                </div>
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">WITH OR WITHOUT PAY</th>
                        ...
                        <tbody>
                            ...
                            @foreach ($requestLeaves as $requestLeave)
                                <tr>
                                    ...
                                    <td>
                                        {{ ($requestLeave->is_with_pay) ? 'WITH PAY' : 'WITHOUT PAY' }}
                                    </td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <form action="/leave/request/update/to/pending/{{ $requestLeave->request_leave_id }}" method="post">
                                                @method('PUT')
                                                @csrf
